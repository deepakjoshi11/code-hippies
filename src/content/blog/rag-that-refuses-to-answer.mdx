...
description: "Everyone measures retrieval hit rate. Almost nobody tests whether the assistant correctly says \"I don't know\" — the failure that actually costs a customer."
