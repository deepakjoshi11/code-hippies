---
title: "What Google actually sees on your React site (and how to check in 30 seconds)"
description: "A client-rendered page can be indexed eventually, sometimes. A server-rendered one is indexed reliably. Here is how to find out which one you shipped, using curl and nothing else."
