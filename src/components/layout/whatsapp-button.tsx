...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed right-4 z-50 flex h-14 items-center gap-3 rounded-full bg-[#25D366] pl-4 pr-4 text-ink-950 shadow-[0_8px_30px_rgba(37,211,102,0.35)] transition-[padding,transform,box-shadow] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] hover:scale-[1.03] hover:shadow-[0_10px_38px_rgba(37,211,102,0.5)] focus-visible:scale-[1.03] motion-safe:animate-[wa-breathe_3.2s_ease-in-out_infinite] md:right-6"
      style={{
        bottom: "calc(1rem + env(safe-area-inset-bottom, 0px))",
        paddingRight: open ? "1.25rem" : "1rem",
      }}
    >
      <span
        aria-hidden="true"
      ...
      <span
        className={`relative overflow-hidden whitespace-nowrap text-sm font-semibold transition-[max-width,opacity] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
